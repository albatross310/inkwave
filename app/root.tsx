...
export const links: LinksFunction = () => [
  { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/fav-32.png?v=7' },
  { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/fav-16.png?v=7' },
  { rel: 'icon', type: 'image/png', sizes: '128x128', href: '/fav-128.png?v=7' },
  { rel: 'shortcut icon', href: '/fav-32.png?v=7' },
