...
export function meta() {
  return [
    { title: 'Verify a Record · Inkwave Zero' },
    {
      name: 'description',
      content:
    ...
    { tagName: 'link', rel: 'canonical', href: 'https://iwzero.me/verify' },
    ...
    { property: 'og:url', content: 'https://iwzero.me/verify' },
