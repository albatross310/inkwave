  ...
  return (
    ...
    >
      ...
      <button type="button" onClick={() => setSuggestOn(!suggest)}
        className={`flex items-center justify-center ${iconBtn} rounded-full border text-base transition-colors ${suggest ? 'text-white bg-[#302438] border-[#302438]' : 'text-stone-600 border-stone-200 hover:bg-stone-50'}`}
      ...
      <button type="button" onMouseDown={(e) => e.preventDefault()} onClick={addComment}
        ...
        className={`ml-auto flex items-center justify-center ${iconBtn} rounded-full border text-lg ${hasSelection ? 'text-[#302438] border-[#302438]/40 hover:bg-stone-50' : 'text-stone-300 border-stone-200 cursor-default'}`}
