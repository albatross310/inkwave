...
// with #fff control faces and a #302438 glyph on each — a strip of daylight welded under a dark app,
...
// already ARE that family's: bar #faf8fc, face #fff, outline #d6cfe0, glyph #302438, byte for byte.
 ...
 */
const tint = (a: number) => `rgb(var(--iw-reader-accent-rgb, 48 36 56) / ${a})`
                  ...
                  <div style={{ padding: '4px 8px', lineHeight: 1.45 }}>
                    ...
                    <div style={{ display: 'flex', gap: 6 }}>
                      <button type="button" onClick={() => void runOutput(output.what, output.scale)}
                        style={{ ...(isTouch ? MORE_ITEM_TOUCH : MORE_ITEM), background: 'var(--iw-ink, #302438)', color: 'var(--iw-on-ink, #fff)', textAlign: 'center' }}>
                ...
                {output.phase === 'busy' && (
                  <div style={{ padding: '4px 8px', lineHeight: 1.45 }}>
                    ...
                    <div aria-hidden="true" style={{ height: 4, borderRadius: 2, background: `${HAIR}`, overflow: 'hidden', marginBottom: 8 }}>
                      <div style={{ height: '100%', width: `${output.total ? (100 * output.done) / output.total : 0}%`, background: 'var(--iw-ink, #302438)', transition: 'width 120ms linear' }} />
                    </div>
